        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-5">
              ...
              <button
                type="button"
                onClick={() => setFormData({ email: "driver@bustrack.demo", password: "Demo@1234" })}
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="text-left">
                    <p className="text-sm font-semibold text-gray-800">Driver Account</p>
                    <p className="text-xs text-gray-500">driver@bustrack.demo / Demo@1234</p>
                  </div>
                </div>
